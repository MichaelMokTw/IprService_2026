...
namespace MyProject.WorkerService {
    ...
    public class BaseWorker : BackgroundService {
        ...
        private _BaseDb db => new _BaseDb();
        ...
        public BaseWorker(IHostApplicationLifetime hostLifeTime) {            
            //初始化nlog
        ...
        public override Task StopAsync(CancellationToken cancellationToken) {
            nlog.Info($"{GVar.ProjectName} 服務已正常停止");
            return base.StopAsync(cancellationToken);
        }
        public override void Dispose() {
            nlog.Info($"{GVar.ProjectName} 服務已正常釋放");
            base.Dispose();
        }
