        ...
        public async Task<ApiResponseModel> PostAsync(string url, string body, string bodyMediaType = null, string responseContentType = "application/json",
            ...
            try {
                using (HttpClient client = _httpClientFactory.CreateClient(hostName)) {                
                    ...
                    StringContent content = new StringContent(body, global::System.Text.Encoding.UTF8, mediaType: bodyMediaType);
                    if (!string.IsNullOrWhiteSpace(responseContentType)) {
                        content.Headers.ContentType = global::System.Net.Http.Headers.MediaTypeHeaderValue.Parse(responseContentType);
                    }
